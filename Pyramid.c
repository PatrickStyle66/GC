...
static GLubyte piramideF1[] = {0,2,10};
static GLubyte piramideF2[] = {2,6,10};
static GLubyte piramideF3[] = {6,5,10};
static GLubyte piramideF4[] = {5,0,10};
...
void display(void){
    ...
    glColor3f(VERMELHO);
    glDrawElements(GL_POLYGON, 3, GL_UNSIGNED_BYTE, piramideF1);

    glColor3f(AMARELO);
    glDrawElements(GL_POLYGON, 3, GL_UNSIGNED_BYTE, piramideF2);

    glColor3f(AZUL);
    glDrawElements(GL_POLYGON, 3, GL_UNSIGNED_BYTE, piramideF3);

    glColor3f(CYAN);
    glDrawElements(GL_POLYGON, 3, GL_UNSIGNED_BYTE, piramideF4);
